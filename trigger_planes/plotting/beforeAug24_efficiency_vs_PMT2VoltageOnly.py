...
efficiency = array('d', [0.9860,0.9820,0.9920,0.9821,0.9820,0.9840,0.9840]) #write efficiency values

efficiency_error = array('d', [0.0052,0.0059,0.0040,0.0059,0.0059,0.0056,0.0056]) #Write the efficiency errors
...
graph.Draw("AP")
canvas.SaveAs("beforeAug24_efficiency_vs_PMT2VoltageOnly.png")
